...
export function AudioPlayerBar() {
  ...
  }, [currentMedia, isAudio, isPlaying, getAudioSrc])
  ...
  return (
    <>
      ...
      {/* Player Bar */}
      <div className="fixed bottom-0 left-0 right-0 z-50 h-20 border-t border-border/50 bg-background/80 backdrop-blur-xl supports-[backdrop-filter]:bg-background/60">
